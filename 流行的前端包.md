...
> Recently revised in 02 Nov 2023
...
| [jsdom](https://healeycodes.com/sandboxing-javascript-code) |                                                  | 纯 JS 实现的 DOM                       |
|                                                             |                                                  |                                        |
|                                                             |                                                  |                                        |
...
| luxon       | working with dates and times in JavaScript.   |                            |
...
更倾向于在前端使用，这些包默认是不依赖框架，或者在多个框架中都可以使用的
...
| qrcode                           |                                                              | 生成二维码                                |
| selecto                          | allows select elements in the drag area using the mouse or touch. | 在可拖拽的区域可以选中组件                |
...
| react-quick-pinch-zoom                                      |                                                              | 多点触控手势放大和拖动任何 DOM 元素 |
| zustand                                                     |                                                              | 状态管理                            |
|                                                             |                                                              |                                     |
|                                                             |                                                              |                                     |
|                                                             |                                                              |                                     |
...
| 组件名称 | 文档类型                                                     | 介绍              |
| -------- | ------------------------------------------------------------ | ----------------- |
| sugarss  | Indent-based CSS syntax for [PostCSS](https://github.com/postcss/postcss). | 强缩进CSS语法检测 |